...
8. Only point the user to the dashboard/report after reviewed graph validation passes. Do not expose dashboard/devCommand for a runtime-only graph; in the cockpit it must remain internal preview mode.
